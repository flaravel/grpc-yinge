...
namespace Yinge\Grpc\Vision\RCBatchRequest;
...
/**
 * Generated from protobuf message <code>Vision.RCBatchRequest.Block</code>
 */
...
class_alias(Block::class, \Yinge\Grpc\Vision\RCBatchRequest_Block::class);
